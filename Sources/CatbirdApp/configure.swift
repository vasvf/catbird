...
//    
//    let fileStore = LoggedStore(
//        store: FileStore(path: appConfig.mocksDirectory),
//        logger: SystemLogger.category("File"))
//
//    let dataResponseStore = MemoryStore()
...
//        middlewares.use(InterseptStoreMiddleware(store: fileStore))
